...
Starts:
  ...
  - RViz2
  - EKF localization, localisation, global_planner, local_planner, frenet_planner, path_tracker
...
def generate_launch_description():
    ...
    # ROS ↔ Gazebo bridge
    # Remapping strategy:
    #   /autocar/cmd_vel  (ROS, safety gate) -> /model/autocar/cmd_vel (gz plugin input)
